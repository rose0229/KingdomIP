...
export const serviceCategories = [
  {
    ...
    services: [
      ...
      ["Website Strategy", "For teams deciding what their website needs next before they hire a builder, change platforms, or start making major updates.", "Audience, visitor actions, required pages, brand assets, platform fit, timeline, and examples you admire.", "A clear website direction, priority page plan, copy and structure recommendations, and next-step options.", "Scoped after intake"],
